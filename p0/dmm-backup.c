...
void* dmalloc(size_t numbytes) {
    ...
    if (heapIsCompletelyFull) {
        ...
        while ((candidatePointer->size - METADATA_T_ALIGNED - METADATA_F_ALIGNED < blockSize) && (candidatePointer->size != blockSize)) {
            /* this block is too small */
            if (candidatePointer->next == NULL) {
